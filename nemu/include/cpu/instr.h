...
int jg_short(uint32_t eip,uint8_t opcode);
int jng_short(uint32_t eip,uint8_t opcode);
int jne_short(uint32_t eip,uint8_t opcode);
...
int jbe_near(uint32_t eip,uint8_t opcde);
...
int jl_short(uint32_t eip,uint8_t opcode);
...
int jge_short(uint32_t eip,uint8_t opcode);
