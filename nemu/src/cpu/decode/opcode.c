...
instr_func opcode_entry[256] = {
    ...
    /* 0x40 - 0x43*/ inc_r_v, inc_r_v, inc_r_v, inv,
    ...
    /* 0x54 - 0x57*/ inv, push_ebp_v, push_esi_v, push_edi_v,
    /* 0x58 - 0x5b*/ inv, inv, inv, pop_ebx_v,
    /* 0x5c - 0x5f*/ inv, pop_ebp_v, inv, inv,
    ...
    /* 0x74 - 0x77*/ je_short, jne_short, jna_short, inv,
    /* 0x78 - 0x7b*/ inv, inv, inv, inv,
    /* 0x7c - 0x7f*/ jl_short, jge_short, jng_short, jg_short,
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x84 - 0x87*/ inv, inv, jbe_near, inv,
