...
instr_func opcode_entry[256] = {
    ...
    /* 0x50 - 0x53*/ inv, inv, inv, push_ebx_v,
    /* 0x54 - 0x57*/ inv, push_ebp_v, inv, inv,
    ...
    /* 0x74 - 0x77*/ je_short, inv, jna_short, inv,
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, call_near_indirect, inv, jmp_near, inv, push_rm_v, inv};
