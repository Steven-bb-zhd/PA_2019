...
instr_func opcode_entry[256] = {
    ...
    /* 0xa8 - 0xab*/ __ref_test_i2a_b, __ref_test_i2a_v, __ref_stos_b, inv,
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, ret_near_imm16, __ref_ret_near,
...
instr_func group_5_indirect_entry[8] =
    {__ref_inc_rm_v, __ref_dec_rm_v, inv, inv, jmp_rm_v, inv, __ref_push_rm_v, inv};
