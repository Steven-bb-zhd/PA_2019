...
instr_func group_1_bv_entry[8] =
    {__ref_add_i2rm_bv, or_i2rm_bv, __ref_adc_i2rm_bv, sbb_i2rm_bv, __ref_and_i2rm_bv, sub_i2rm_bv, xor_i2rm_bv, cmp_i2rm_bv};
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, call_near_indirect, inv, jmp_rm_v, inv, push_rm_v, inv};
